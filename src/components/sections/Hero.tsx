...
const EVENTOS_INICIALES: EventoTerritorial[] = [
 {
  ...
  subtexto: 'CONF 0.94',
  cx: 480, // Mismo eje vertical del río
  cy: 230  // Más al norte (arriba)
},
  {
    id: '2',
    tiempo: '0:04:51',
  ...
  cx: 480, // Mismo eje vertical del río
  cy: 340  // Más al sur que Sabanalarga (abajo)
}
]

// Nodos estáticos secundarios para rellenar el mapa geográfico como en la foto
...
export function HeroSection() {
  ...
  // Cambio dinámico de evento cada 8 segundos con recuadro iluminado
  useEffect(() => {
  ...
  return (
    <section className="relative w-full pt-20 pb-16 bg-[#0A0A0B] border-b border-[rgba(237,234,227,0.11)] overflow-hidden">
      {/* Retícula de fondo */}
      ...
      <div className="max-w-340 mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="flex items-center gap-3 font-mono text-[11px] tracking-[0.16em] uppercase text-[#9A968C]">
              ...
              <span>PÁRAMO <span className="text-[#FF9E1B]">//</span> PLATAFORMA V4.2</span>
            </div>

            <h1 className="text-4xl sm:text-5xl font-extrabold uppercase tracking-tight text-[#EDEAE3] leading-[0.98]">
              EL SISTEMA OPERATIVO DEL <span className="text-transparent [ -webkit-text-stroke:1.5px_#FF9E1B ]">OCCIDENTE</span> ANTIOQUEÑO.
            </h1>

            <p className="text-base text-[#9A968C] max-w-xl leading-relaxed">
              Ingesta de datos territoriales, analítica predictiva de negocios y visión artificial en cultivos. La infraestructura de inteligencia de datos para entender el presente y predecir el futuro del Occidente Antioqueño.
            </p>

            <div className="flex flex-wrap items-center gap-3 pt-2">
              <a
                href="#acceso"
                className="inline-flex items-center gap-2 font-mono text-[11px] tracking-[0.14em] uppercase px-5 py-3 bg-[#FF9E1B] border border-[#FF9E1B] text-[#0A0A0B] font-semibold hover:bg-[#EDEAE3] hover:border-[#EDEAE3] transition-all"
              >
                SOLICITAR DEMO <ArrowRight size={14} />
              </a>
              <a
                href="#plataforma"
                className="inline-flex items-center gap-2 font-mono text-[11px] tracking-[0.14em] uppercase px-5 py-3 border border-[rgba(237,234,227,0.11)] text-[#EDEAE3] hover:border-[#EDEAE3] hover:bg-[rgba(237,234,227,0.05)] transition-all"
              >
                EXPLORAR PLATAFORMA
              </a>
            </div>
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 pt-4 border-t border-[rgba(237,234,227,0.11)] font-mono text-[10.5px] tracking-[0.1em] text-[#5E5B52]">
              <span>SANTA FE DE ANTIOQUIA <b className="text-[#9A968C] font-normal">6.5506°N · 75.8281°W</b></span>
              <span>ELEV <b className="text-[#9A968C] font-normal">550 MSNM</b></span>
            </div>
          </div>

          {/* COLUMNA DERECHA: VISOR TÁCTICO */}
          <div className="lg:col-span-7">
            <div className="relative border border-[rgba(237,234,227,0.11)] bg-[#0B0B0D]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 min-h-100">
                ...
                {/* MAPA SVG TÁCTICO GEORREFERENCIADO COMPLETO */}
                <div className="md:col-span-7 border-r border-[rgba(237,234,227,0.11)] relative flex items-center justify-center bg-[#070708] overflow-hidden p-2 min-h-[420px]">
                  <svg
                    id="map"
                  ...
                  >
                    ...
                    {/* Etiquetas Coordenadas GPS en bordes */}
                    ...
                    {/* SILUETA GEOGRÁFICA DEL OCCIDENTE */}
                    <path
                    ...
                    {/* Línea Vía al Mar (Curva discontinua) */}
                    <path
                    ...
                    {/* ABANICO DE RADAR EN ROTACIÓN */}
                    <g transform={`rotate(${angle}, ${cx}, ${cy})`}>
                      <path d={radarSectorPath} fill="url(#radarSweep)" />
                      <line x1={cx} y1={cy} x2={x2} y2={y2} stroke="#FF9E1B" strokeWidth="2.8" strokeOpacity="0.8" />
                    </g>

                    {/* NODOS SECUNDARIOS (Nombres más legibles) */}
                    <g fill="#7A776E" fontSize="11" fontFamily="monospace">
                    ...
                    {/* NODOS PRINCIPALES CON EVENTOS (Nombres resaltados y legibles) */}
                ...
                {/* PANEL LATERAL DE REGISTRO DE EVENTOS */}
                <div className="md:col-span-5 flex flex-col bg-[#0B0B0D]">
                  ...
                  <div className="flex-1 max-h-[420px] overflow-y-auto divide-y divide-[rgba(237,234,227,0.08)]">
                    {eventosFiltrados.map((item) => {
                      ...
                      return (
                        <div
                          key={item.id}
                          className={`p-4 font-mono flex flex-col gap-1 transition-all duration-500 ${
                            isHighlighted
